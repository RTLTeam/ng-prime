...
@Component({
    ...
    template: `<div class="atlantis template">
        ...
        <div [style.display]="'none'">
            <atlantis-separator></atlantis-separator>
            <template-youtube imgSrc="https://primefaces.org/cdn/ng_prime/images/templates/atlantis/atlantis-youtube-screen.png"></template-youtube>
        </div>
...
export class AtlantisPage {
    ...
    templateHeroData = {
        pattern: 'https://primefaces.org/cdn/ng_prime/images/templates/atlantis/atlantis-hero-pattern.png',
        dashboard1: 'https://primefaces.org/cdn/ng_prime/images/templates/atlantis/atlantis-hero-dashboard1.png',
        dashboard2: 'https://primefaces.org/cdn/ng_prime/images/templates/atlantis/atlantis-hero-dashboard2.png',
    ...
    features2Data = [
        {
            ...
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/atlantis/atlantis-features2-responsive.png'
        },
        {
        ...
        },
        {
            ...
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/atlantis/atlantis-features2-ready.png'
        },
        {
            title: 'Mobile Experience',
            description: 'Touch optimized enhanced mobile experience with responsive design.',
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/atlantis/atlantis-features2-mobile.png'
        }
    ];
    ...
    animationFeaturesData1 = [
        ...
        },
        {
            ...
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/atlantis/features-animation-figma.png'
        }
    ];
    ...
    animationFeaturesData2 = [
        {
            ...
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/atlantis/features-animation-darkmode.png'
        },
        {
            id: 2,
            ...
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/atlantis/features-animation-component-themes.png'
        },
        {
            id: 3,
            ...
            inlineFeaturesData: [
                {
                    id: 1,
                    title: 'Static',
                    src: 'https://primefaces.org/cdn/ng_prime/images/templates/atlantis/Static.png'
                },
                {
                    id: 2,
                    title: 'Slim',
                    src: 'https://primefaces.org/cdn/ng_prime/images/templates/atlantis/Slim.png'
                },
                {
                    id: 3,
                    title: 'Reveal',
                    src: 'https://primefaces.org/cdn/ng_prime/images/templates/atlantis/Reveal.png'
                },
                {
                    id: 4,
                    title: 'Horizontal',
                    src: 'https://primefaces.org/cdn/ng_prime/images/templates/atlantis/Horizontal.png'
                },
                {
                    id: 5,
                    title: 'Overlay',
                    src: 'https://primefaces.org/cdn/ng_prime/images/templates/atlantis/Overlay.png'
                },
                {
                    id: 6,
                    title: 'Slim+',
                ...
                },
                {
                    id: 7,
                    title: 'Drawer',
                    src: 'https://primefaces.org/cdn/ng_prime/images/templates/atlantis/Drawer.png'
                }
            ]
        }
    ];
    ...
    license = {
        documentLink: 'https://atlantis.ng_prime.org/documentation',

...
@Component({
    ...
    template: `<div class="ultima template">
        ...
        <div [style.display]="'none'">
            <ultima-separator></ultima-separator>
            <template-youtube imgSrc="https://primefaces.org/cdn/ng_prime/images/templates/ultima/ultima-youtube-screen.png"></template-youtube>
        </div>
...
export class UltimaPage {
    ...
    templateHeroData = {
        pattern: 'https://primefaces.org/cdn/ng_prime/images/templates/ultima/ultima-hero-pattern.png',
        ...
        dashboard1: 'https://primefaces.org/cdn/ng_prime/images/templates/ultima/ultima-hero-dashboard1.png',
        dashboard2: 'https://primefaces.org/cdn/ng_prime/images/templates/ultima/ultima-hero-dashboard2.png',
        liveHref: 'https://ultima.ng_prime.org',
        docHref: 'https://ultima.ng_prime.org/documentation'
    };
    ...
    animationFeaturesData1 = [
        ...
        },
        {
            ...
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/ultima/features-animation-figma.png'
        }
    ];
    ...
    animationFeaturesData2 = [
        {
            ...
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/ultima/features-animation-darkmode.png'
        },
        {
            id: 2,
            ...
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/ultima/features-animation-component-themes.png'
        },
        {
            id: 3,
            ...
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/atlantis/features-animation-orientations.png',
            type: 'inline-animation',
            inlineFeaturesData: [
                {
                    id: 1,
                    title: 'Static',
                    src: 'https://primefaces.org/cdn/ng_prime/images/templates/ultima/Static.png'
                },
                {
                    id: 2,
                    title: 'Slim',
                    src: 'https://primefaces.org/cdn/ng_prime/images/templates/ultima/Slim.png'
                },
                {
                    id: 3,
                    title: 'Reveal',
                    src: 'https://primefaces.org/cdn/ng_prime/images/templates/ultima/Reveal.png'
                },
                {
                    id: 4,
                    title: 'Horizontal',
                    src: 'https://primefaces.org/cdn/ng_prime/images/templates/ultima/Horizontal.png'
                },
                {
                    id: 5,
                    title: 'Overlay',
                    src: 'https://primefaces.org/cdn/ng_prime/images/templates/ultima/Overlay.png'
                },
                {
                    id: 6,
                    title: 'Slim+',
                ...
                },
                {
                    id: 7,
                    title: 'Drawer',
                    src: 'https://primefaces.org/cdn/ng_prime/images/templates/ultima/Drawer.png'
                }
            ]
        }
    ];
    ...
    license = {
        documentLink: 'https://ultima.ng_prime.org/documentation/',

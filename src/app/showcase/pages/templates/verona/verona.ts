...
@Component({
    ...
    template: `<div class="verona template">
        ...
        <div [style.display]="'none'">
            <verona-separator></verona-separator>
            <template-youtube imgSrc="https://primefaces.org/cdn/ng_prime/images/templates/verona/verona-youtube-screen.png"></template-youtube>
        </div>
...
export class VeronaPage {
    ...
    templateHeroData = {
        pattern: 'https://primefaces.org/cdn/ng_prime/images/templates/verona/verona-hero-pattern.png',
        ...
        dashboard1: 'https://primefaces.org/cdn/ng_prime/images/templates/verona/verona-hero-dashboard1.png',
        dashboard2: 'https://primefaces.org/cdn/ng_prime/images/templates/verona/verona-hero-dashboard2.png',
        liveHref: 'https://verona.ng_prime.org/',
        docHref: 'https://verona.ng_prime.org/documentation'
    };
    ...
    features2Data = [
        {
            ...
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/verona/verona-features2-responsive.png'
        },
        {
        ...
        },
        {
            title: 'Ready to Use Pages',
            description: 'Landing, login, invoice, help, user management and error pages are provided as template pages to get started with building your app.',
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/verona/verona-features2-ready.png'
        },
        {
            title: 'Mobile Experience',
            description: 'Touch optimized enhanced mobile experience with responsive design.',
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/verona/verona-features2-mobile.png'
        }
    ];
    ...
    animationFeaturesData1 = [
        ...
        },
        {
            ...
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/verona/features-animation-figma.png'
        }
    ];
    ...
    animationFeaturesData2 = [
        {
            ...
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/verona/features-animation-darkmode.png'
        },
        {
            id: 2,
            ...
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/verona/features-animation-component-themes.png'
        },
        {
            id: 3,
            title: '4 Menu Orientations',
            description: 'Choose from Static, Overlay, Slim and Slim+ menu orientations.',
            src: 'https://primefaces.org/cdn/ng_prime/images/templates/verona/features-animation-orientations.png',
            type: 'inline-animation',
            inlineFeaturesData: [
                {
                    id: 1,
                    title: 'Static',
                    src: 'https://primefaces.org/cdn/ng_prime/images/templates/verona/Static.png'
                },
                {
                    id: 2,
                    title: 'Slim',
                    src: 'https://primefaces.org/cdn/ng_prime/images/templates/verona/Slim.png'
                },
                {
                    id: 3,
                    title: 'Slim+',
                ...
                },
                {
                    id: 4,
                    title: 'Overlay',
                    src: 'https://primefaces.org/cdn/ng_prime/images/templates/verona/Overlay.png'
                }
            ]
        },
        {
    ...
    license = {
        documentLink: 'https://verona.ng_prime.org/documentation',

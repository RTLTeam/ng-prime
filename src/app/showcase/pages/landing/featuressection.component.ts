                    ...
                    <div class="grid">
                        <div class="col-12 md:col-6 xl:col-3 flex justify-content-center">
                            <div class="box p-4 w-full">
                                <img src="https://primefaces.org/cdn/ng_prime/images/landing/features/icon-components.svg" width="30" height="25" class="block mb-3" alt="components icon" />
                        ...
                        <div class="col-12 md:col-6 xl:col-3 flex justify-content-center">
                            <div class="box p-4 w-full">
                                <img src="https://primefaces.org/cdn/ng_prime/images/landing/features/icon-community.svg" width="30" height="25" alt="components icon" class="block mb-3" />
                        ...
                        <div class="col-12 md:col-6 xl:col-3 flex justify-content-center">
                            <div class="box p-4 w-full">
                                <img src="https://primefaces.org/cdn/ng_prime/images/landing/features/icon-productivity.svg" width="30" height="25" alt="components icon" class="block mb-3" />
                        ...
                        <div class="col-12 md:col-6 xl:col-3 flex justify-content-center">
                            <div class="box p-4 w-full">
                                <img src="https://primefaces.org/cdn/ng_prime/images/landing/features/icon-accessibility.svg" alt="components icon" class="block mb-3" />
                        ...
                        <div class="col-12 md:col-6 xl:col-3 flex justify-content-center">
                            <div class="box p-4 w-full">
                                <img src="https://primefaces.org/cdn/ng_prime/images/landing/features/icon-support.svg" alt="components icon" width="30" height="25" class="block mb-3" />
                        ...
                        <div class="col-12 md:col-6 xl:col-3 flex justify-content-center">
                            <div class="box p-4 w-full">
                                <img src="https://primefaces.org/cdn/ng_prime/images/landing/features/icon-mobile.svg" width="30" height="25" alt="components icon" class="block mb-3" />
                        ...
                        <div class="col-12 md:col-6 xl:col-3 flex justify-content-center">
                            <div class="box p-4 w-full">
                                <img src="https://primefaces.org/cdn/ng_prime/images/landing/features/icon-theme.svg" width="30" height="25" alt="components icon" class="block mb-3" />
                        ...
                        <div class="col-12 md:col-6 xl:col-3 flex justify-content-center">
                            <div class="box p-4 w-full">
                                <img src="https://primefaces.org/cdn/ng_prime/images/landing/features/icon-ts.svg" width="30" height="25" alt="components icon" class="block mb-3" />

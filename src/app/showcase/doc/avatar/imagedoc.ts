    ...
    template: `
        ...
        <div class="card">
            <div class="flex flex-wrap gap-5">
                <div class="flex-auto">
                    <p-avatar image="https://primefaces.org/cdn/ng_prime/images/demo/avatar/amyelsner.png" styleClass="mr-2" size="xlarge" shape="circle" />
                    <p-avatar image="https://primefaces.org/cdn/ng_prime/images/demo/avatar/asiyajavayant.png" styleClass="mr-2" size="large" shape="circle" />
                    <p-avatar image="https://primefaces.org/cdn/ng_prime/images/demo/avatar/onyamalimba.png" styleClass="mr-2" shape="circle" />
                </div>
                <div class="flex-auto">
                    <h5>Badge</h5>
                    <p-avatar pBadge value="4" image="https://primefaces.org/cdn/ng_prime/images/demo/avatar/walter.jpg" size="xlarge" badgeSize="large" />
                </div>
                <div class="flex-auto">
                    <h5>Gravatar</h5>
...
<p-avatar
    pBadge
    value="4"
    image="https://primefaces.org/cdn/ng_prime/images/demo/avatar/walter.jpg"
    size="xlarge"
    badgeSize="large" />
    ...
    <div class="flex flex-wrap gap-5">
        ...
        <div class="flex-auto">
            ...
            <p-avatar
                pBadge
                value="4"
                image="https://primefaces.org/cdn/ng_prime/demo/avatar/walter.jpg"
                size="xlarge"
                badgeSize="large" />
        </div>
        <div class="flex-auto">

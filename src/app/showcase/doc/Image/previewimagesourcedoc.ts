...
@Component({
    ...
    template: `
        ...
        <div class="card flex justify-content-center">
            <p-image src="https://primefaces.org/cdn/ng_prime/images/galleria/galleria11.jpg" previewImageSrc="https://primefaces.org/cdn/ng_prime/images/galleria/galleria11.jpg" alt="Image" width="250" [preview]="true" />
        </div>
...
export class PreviewImageSourceDoc {
    code: Code = {
        basic: `<p-image
    src="https://primefaces.org/cdn/ng_prime/images/galleria/galleria11.jpg"
    previewImageSrc="https://primefaces.org/cdn/ng_prime/images/galleria/galleria11.jpg"
    alt="Image"
    width="250"
    [preview]="true" />`,

    ...
    template: `
        <app-docsectiontext>
            <p>
                ...
                of PrimeFlex and currently does not provide an extended style property like <i>sx</i>. Same approach is also utilized in <a href="https://blocks.ng_prime.org">PrimeBlocks for PrimeNG</a> project as well.
            </p>
        </app-docsectiontext>

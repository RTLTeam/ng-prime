                                ...
                                optionLabel="name">
                                    <ng-template let-option pTemplate="item">
                                        <div class="inline-block vertical-align-middle">
                                            <img
                                                [alt]="option.label"
                                                src="https://primefaces.org/cdn/ng_prime/images/demo/avatar/{{ option.image }}"
                                                width="24"
                        ...
                        <p-multiSelect
                            ...
                            optionLabel="name">
                                <ng-template let-option pTemplate="item">
                                    <div class="inline-block vertical-align-middle">
                                        <img
                                            [alt]="option.label" src="https://primefaces.org/cdn/ng_prime/images/demo/avatar/{{ option.image }}"
                                            width="24"
                                            class="vertical-align-middle" />
